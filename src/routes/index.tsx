...
import resumePDF from "@/assets/Mishika Bhandari.pdf";
    ...
    <div className="min-h-screen text-foreground">
        ...
        <div className="mx-auto max-w-6xl px-4 sm:px-6 grid lg:grid-cols-[1.1fr_0.9fr] gap-12 items-center">
          <div>
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              ...
              <a href={resumePDF} download="Mishika Bhandari.pdf" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 px-5 py-3 rounded-xl glass font-semibold hover:scale-[1.03] transition-transform">
      ...
      <Section id="resume" eyebrow="Resume" title="One page, zero fluff">
        <div data-reveal className="glass-card rounded-3xl p-8 sm:p-10 grid md:grid-cols-[1fr_auto] gap-6 items-center">
          ...
          <a href={resumePDF} download="Mishika Bhandari.pdf" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 px-6 py-3.5 rounded-xl gradient-bg text-primary-foreground font-semibold shadow-glow hover:scale-[1.03] transition-transform">
